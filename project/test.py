...
model = YOLO('C:/Users/Admin/Desktop/Project/SignSpotter/runs/detect/train11/weights/best.pt')
...
def process_image(file_path):
    ...
    result_path = os.path.join(output_dir, f'processed_{os.path.basename(file_path)}')
...
# Function to process all images in a selected folder
def process_folder():
...
button_folder_upload = tk.Button(root, text="Upload Folder", command=process_folder)
button_folder_upload.pack(pady=10)
